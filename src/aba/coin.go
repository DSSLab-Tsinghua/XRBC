...
// import (
// 	"asynclib/src/communication/sender"
// 	"asynclib/src/cryptolib"
// 	"asynclib/src/logging"
// 	"asynclib/src/message"
// 	"asynclib/src/quorum"
// 	"asynclib/src/utils"
// 	"fmt"
// 	"log"
...
// func GenCoin(nodeid int64, instanceid int, roundnum int, sessionid int) {
// 	round.Insert(instanceid, roundnum)
// 	go HandleCachedMsg(instanceid, roundnum)
// 	sender.CoinBroadcast(nodeid, instanceid, roundnum, sessionid, message.PRF)
// }
