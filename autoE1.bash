...
parse_log_and_write_results() {
    ...
    log_info "Parsing log files from directories 4 to 35 for date: $current_date"
...
Average Total Latency(ms): $avg_total
Average {Cross} Latency (ms): $avg_cross
Average Consensus in B Latency: $avg_consensus

EOF
    
    log_success "Results written to $result_file"
    log_info "E1: Number Of Nodes: $num_nodes_B, Number Of Nodes (Group A): $num_nodes_A, Number of Request: $num_requests, Average Total Latency(ms): $avg_total, Average {Cross} Latency (ms): $avg_cross, Average Consensus in B Latency: $avg_consensus"
...
main() {
    ...
    #t=1(n=4), f=10(m=31)
    ./autoConfig.bash 4 31 100 etc/conf.json
